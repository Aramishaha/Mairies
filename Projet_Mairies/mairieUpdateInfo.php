...
require('mairieUpdateInfoAction.php'); ?>
...
<body>
    ...
    <form class="container" method="POST">
        ...
        <input type="hidden" class="form-control" name="idMairie" value="<?php echo htmlspecialchars($_POST['idMairie'] ?? ''); ?>">
        ...
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Adresse complément</label>
        ...
        <button type="submit" class="btn btn-primary" name="validate">Mettre à jour</button>';
            ...
            echo '<li><a href="index.html">Connectez-vous pour effectuer les modification</a></li>';
        }
        ?>
        <br><br>
